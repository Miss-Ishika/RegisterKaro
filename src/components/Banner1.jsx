  ...
  return (
    <div className='flex flex-col gap-8 items-center my-24'>
        ...
        <div className='md:flex gap-16'> 
            <img src={oracle} className='h-[60px]'/>
            <img src={morpheus} className='h-[40px] mt-[10px]'/>
            <img src={morpheus} className='h-[40px] mt-[10px]'/>
            <img src={samsung} className='h-[130px] mt-[-35px]'/>
            <img src={monday} className='h-[50px]'/>
            <img src={segment} className='h-[30px] mt-[10px]'/>
        </div>
    </div>
  )
}
